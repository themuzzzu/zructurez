...
export const ServiceProductForm = ({ serviceId, onSuccess }: ServiceProductFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If marketplace listing is enabled, also add to products table
      ...
      toast.success(`Product added successfully${listInMarketplace ? ' and listed in marketplace' : ''}`);
      onSuccess?.();
      setFormData({
        name: "",
        description: "",
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <Label htmlFor="marketplace">Also list in marketplace</Label>
      </div>
