...
>(({ className, ...props }, ref) => (
  <Card
    ref={ref}
    className={cn(
      "overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer w-full max-w-[360px] bg-black text-white flex flex-col h-full hover:scale-[1.01]",
      className
    )}
    {...props}
  />
