...
// Sample banner data (first 5 entries only for better performance)
...
export const BannerCarousel = () => {
  ...
  // Use a smaller subset of banners for better performance
